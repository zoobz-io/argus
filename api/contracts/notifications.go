...
type Notifications interface {
	...
	// UpdateStatus updates the status of a single notification owned by the user.
	UpdateStatus(ctx context.Context, tenantID string, userID string, id string, status models.NotificationStatus) (*models.Notification, error)
