...
type Subscriptions interface {
	...
	CreateSubscription(ctx context.Context, tenantID string, userID string, eventType string, channel models.SubscriptionChannel, webhookEndpointID string) (*models.Subscription, error)
